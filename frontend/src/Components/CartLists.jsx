...
const CartLists = ({ cartItems, handleOrder }) => {
  ...
  return (
    <Box mt={"80px"} h={"100vh"} bg="url('https://static.vecteezy.com/system/resources/thumbnails/023/308/048/small_2x/abstract-grey-metallic-overlap-on-dark-circle-mesh-pattern-design-modern-luxury-futuristic-background-vector.jpg')" color={"red"} className="mt-20 h-screen">
      {cartItems.map((cart) => (
