...
const BookDetails = () => {
  ...
  return (
    <Box mt={"80px"} border={"3px solid black"} bg="url('https://static.vecteezy.com/system/resources/thumbnails/023/308/048/small_2x/abstract-grey-metallic-overlap-on-dark-circle-mesh-pattern-design-modern-luxury-futuristic-background-vector.jpg')" color={"white"} p={4} justifyContent={"center"} alignItems={"center"}>
